...
flags.DEFINE_string("model_name", "face_h_fm_again4", "model_name")
flags.DEFINE_string("reverser_model_name", "/mnt/images/models/gans/anoface_h_fm_again4", "model_name")
