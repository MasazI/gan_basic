...
flags.DEFINE_integer("image_height", 28, "The size of image to use (will be center cropped) [64]")
flags.DEFINE_integer("image_width", 28, "The size of image to use (will be center cropped) [64]")
