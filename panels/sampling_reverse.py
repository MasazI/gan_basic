...
flags.DEFINE_string("model_name", "/mnt/images/models/gans/rpanels_fm_cos", "model_name")
...
flags.DEFINE_string("g_model_name", "/mnt/images/models/gans/panels_fm", "model_name")
