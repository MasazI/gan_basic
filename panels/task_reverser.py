...
flags.DEFINE_string("model_name", "/mnt/images/models/gans/panels_fm", "model_name")
flags.DEFINE_string("data_dir", "/mnt/images/vcube/panel_20170501/panel/DJI_0014", "data dir path")
flags.DEFINE_string("reverser_model_name", "/mnt/images/models/gans/rpanels_fm_cos2", "model_name")
...
#        r_loss2 = tf.div(1.0, cosine_similarity)
        ...
        return r_loss, r_loss_sum, r_loss1_sum, r_loss2_sum
...
def train():
    ...
    r_loss, r_loss_sum, r_loss1_sum, r_loss2_sum = dcgan.cost(R1_logits, z)
    ...
    # summary
    r_sum = tf.summary.merge([z_sum, R_sum, r_loss_sum, r_loss1_sum, r_loss2_sum])
